...
export const DICTIONARY = {
  ...
  clearEverythingExplained: { en: 'This removes every uploaded file and everything read from it. Invoices already filed in the accounting system stay there and cannot be removed from here.', ja: 'アップロードしたファイルと読み取り結果をすべて削除します。会計システムに登録済みの請求書はそのまま残り、ここからは削除できません。' },
  yesClearEverything: { en: 'Yes, delete everything', ja: 'はい、すべて削除します' },
  clearingFailed: { en: 'Nothing was deleted', ja: '削除できませんでした' },
