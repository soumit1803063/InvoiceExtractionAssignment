...
export const DICTIONARY = {
  ...
  accountingSystemHasNoUpdate: { en: 'The accounting system has no update and no single-record delete, so corrections here change our own record only — the figures already filed there cannot be altered.', ja: '会計システムには更新も1件ごとの削除もありません。ここでの訂正は当方の記録のみを変更し、登録済みの金額は変えられません。' },
  ...
  alreadyAcknowledgedByAccountingSystem: { en: 'Already acknowledged by the accounting system', ja: '登録済' },
  ...
  handwrittenNotesWereFoundPage: { en: 'Handwritten notes were found on this page', ja: '手書きメモあり' },
  ...
  reOpenCorrection: { en: 'Re-open for correction', ja: '訂正のため再開' },
  reOpenedCorrection: { en: 'Re-opened for correction', ja: '訂正中' },
  ...
  registeredAs: { en: 'Registered as', ja: '会計ID' },
  ...
  reprocess: { en: 'Reprocess', ja: '再読取' },
  reprocessing: { en: 'Reprocessing…', ja: '再読取中…' },
  reprocessingDidNotStart: { en: 'Reprocessing did not start', ja: '再読取を開始できませんでした' },
  ...
  saveCorrections: { en: 'Save corrections', ja: '保存' },
  ...
  staysQueuePermanentlyNeverRead: { en: 'It stays in the queue permanently and is never read again, even if the same file is scanned.', ja: '一覧に残り続け、同じファイルを読み込んでも再処理されません。' },
  ...
  theseWereReadOffPage: { en: 'These were read off the page and deliberately left out of the extracted fields, because they are not invoice data. Read them before approving. A handwritten change to a bank account, a due date or an amount changes how this invoice must be paid, and nothing in the fields below will warn you about it.', ja: '手書きの内容はページから読み取りましたが、請求データではないため抽出項目には含めていません。承認する前に必ず確認してください。振込先・支払期日・金額への手書きの変更は支払い方法を変えますが、下の項目には何も表示されません。' },
