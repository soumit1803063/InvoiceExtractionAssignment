...
export const DICTIONARY = {
  ...
  detailNoDuplicate: { en: 'No registered document carries the same invoice number for this supplier.', ja: '同じ取引先で同じ請求書番号の登録済み書類はありません。' },
  detailDuplicateOf: { en: 'Already registered as {0}.', ja: '{0} として登録済みです。' },
  ...
  unregister: { en: 'Unregister', ja: '登録を取り消す' },
  unregistering: { en: 'Unregistering…', ja: '取り消し中…' },
  unregisterConfirm: { en: 'Unregister this invoice?', ja: 'この請求書の登録を取り消しますか？' },
  unregisterExplained: { en: 'The accounting system cannot delete one invoice on its own, so every invoice is removed with DELETE /invoices and all the others are registered again. The others keep their data but are given new accounting ids. This document and its uploaded file are deleted here. This cannot be undone.', ja: '会計システムは請求書を 1 件だけ削除できないため、DELETE /invoices ですべて削除し、他の請求書を登録し直します。他の請求書は内容はそのままですが、新しい会計 ID が割り当てられます。この書類とアップロードしたファイルは当アプリから削除されます。取り消しはできません。' },
  yesUnregister: { en: 'Yes, unregister', ja: 'はい、取り消します' },
  unregisterFailed: { en: 'Nothing was unregistered', ja: '登録を取り消せませんでした' },
